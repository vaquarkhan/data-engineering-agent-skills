...
object InstallerData {
    ...
    val coreFiles = listOf(
        ...
        "hooks/contract-check-pre.ps1",
        "hooks/pipeline-review-pre.sh",
        "hooks/pipeline-review-pre.ps1",
        "hooks/incident-mode.sh",
        "hooks/incident-mode.ps1",
        "hooks/backfill-guard.sh",
        "hooks/backfill-guard.ps1",
        "hooks/schema-change-guard.sh",
        "hooks/schema-change-guard.ps1",
        "hooks/cost-check.sh",
        "hooks/cost-check.ps1",
    ...
    val starterPacks = linkedMapOf(
        ...
        "Production Reliability" to listOf(
    ...
    val mcpTemplates = linkedMapOf(
        ...
        "Spark" to listOf("mcp/spark.mcp.json"),
    ...
    val runnableExamples = linkedMapOf(
        ...
        "Databricks Delta Medallion" to listOf(
            ...
            "examples/databricks-delta-medallion/Makefile",
            "examples/databricks-delta-medallion/databricks.yml",
            "examples/databricks-delta-medallion/contracts/silver-contract.yaml",
            "examples/databricks-delta-medallion/contracts/silver-contract-v1.yaml",
            "examples/databricks-delta-medallion/conf/medallion.yaml",
            "examples/databricks-delta-medallion/snapshots/silver_previous.jsonl",
            "examples/databricks-delta-medallion/src/bronze_to_silver.py",
            "examples/databricks-delta-medallion/src/validate_silver.py",
            "examples/databricks-delta-medallion/src/rollback_silver.py",
            "examples/databricks-delta-medallion/src/validate_rollback.py",
        ...
        "AWS Serverless Spark MSK Reliability" to listOf(
        ...
        "Kafka Flink Streaming" to listOf(
            ...
            "examples/kafka-flink-streaming/src/produce_to_kafka.py",
            "examples/kafka-flink-streaming/src/replay.py",
            "examples/kafka-flink-streaming/src/replay_to_kafka.py",
            "examples/kafka-flink-streaming/src/stream_job.py",
            "examples/kafka-flink-streaming/src/kafka_to_postgres.py",
            "examples/kafka-flink-streaming/src/validate_sink.py",
            "examples/kafka-flink-streaming/src/validate_postgres_sink.py",
